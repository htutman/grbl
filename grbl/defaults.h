...
/* The defaults.h file serves as a central default settings selector for different machine
...
#ifdef DEFAULTS_DIY_DRAWING_MACHINE
  // Description: Default settings for @htutman DIY drawing machine (Core-XY with Nema 17 Bipolar 59 Ncm motors, micro servo for pen holder)
  #define DEFAULT_X_STEPS_PER_MM 160.0 // GT2 20T pulley, motor step angle: 1.8 deg (200 steps per full turn), 1/32 microstepping; 200 * 32 / (20 * 2) = 160 [steps / mm]
  ...
  #define DEFAULT_X_MAX_TRAVEL 470.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 325.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 200.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_SPINDLE_RPM_MAX 90.0 // use M3 S<angle>, angle 0..90
  #define DEFAULT_SPINDLE_RPM_MIN 0.0 // rpm
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_STEPPING_INVERT_MASK 0
  #define DEFAULT_DIRECTION_INVERT_MASK 0
  ...
  #define DEFAULT_INVERT_LIMIT_PINS 0 // false
  #define DEFAULT_SOFT_LIMIT_ENABLE 0 // false
  #define DEFAULT_HARD_LIMIT_ENABLE 1  // true; enable hard limits
  #define DEFAULT_INVERT_PROBE_PIN 0 // false
  #define DEFAULT_LASER_MODE 0 // false
  #define DEFAULT_HOMING_ENABLE  1  // true
  #define DEFAULT_HOMING_DIR_MASK 3 // invert coordinates
