...
#define DEFAULTS_DIY_DRAWING_MACHINE // settings for the DIY drawing machine
...
// Use spindle to control the pen's servo
#define SPINDLE_AS_PEN

#define PEN_SHORT 26
#define PEN_LONG  39
// #define INVERT_SERVO // uncoment to invert servo (PEN_LONG <-> PEN_SHORT)
